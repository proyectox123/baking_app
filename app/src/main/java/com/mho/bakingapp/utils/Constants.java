...
import com.mho.bakingapp.BuildConfig;

public class Constants {

    public final static String BUNDLE_RECIPE_LIST = "BUNDLE_RECIPE_LIST";

    public final static String EXTRA_RECIPE = BuildConfig.APPLICATION_ID + ".EXTRA_RECIPE";
